            ...
            <div className="min-h-screen bg-white text-gray-900 dark:bg-gray-950 dark:text-gray-100">
                ...
                <section id="how-it-works" className="px-6 py-24">
                    <div className="mx-auto max-w-5xl">
                        <div className="mb-16 text-center">
                            <h2 className="text-3xl font-bold tracking-tight lg:text-4xl">Two ways to monitor</h2>
                            <p className="mt-4 text-gray-500 dark:text-gray-400">Works out of the box for any site. Goes further for WordPress.</p>
                        </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                                ...
                                <div className="mb-1 text-xs font-semibold uppercase tracking-widest text-primary">Any Website</div>
                                <h3 className="mb-3 text-xl font-bold">Uptime monitoring</h3>
                                <p className="mb-6 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                    Add any URL — no plugin, no setup. SitePulse pings your site on a regular schedule and alerts you the moment it goes down or recovers.
                                </p>
                            ...
                            <div className="rounded-2xl border-2 border-primary/30 bg-primary/5 p-8 shadow-sm dark:bg-primary/5">
                                ...
                                <div className="mb-1 flex items-center gap-2">
                                    <span className="text-xs font-semibold uppercase tracking-widest text-primary">WordPress</span>
                                    <span className="rounded-full bg-primary px-2 py-0.5 text-[10px] font-semibold text-primary-foreground">Full audit</span>
                                </div>
                                <h3 className="mb-3 text-xl font-bold">Monitoring + deep audit</h3>
                                <p className="mb-6 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                    Install the free WordPress plugin, connect it to your account, and unlock full site health reports alongside uptime monitoring.
                                </p>
                                <ol className="space-y-3">
                                    {[
                                        'Create a free account',
                ...
                <section className="bg-gray-50 px-6 py-24 dark:bg-gray-900/50">
                    <div className="mx-auto max-w-6xl">
                        <div className="mb-4 text-center text-xs font-semibold uppercase tracking-widest text-primary">WordPress plugin features</div>
                        <div className="mb-16 text-center">
                            <h2 className="text-3xl font-bold tracking-tight lg:text-4xl">Everything your WordPress site needs</h2>
                            <p className="mt-4 text-gray-500 dark:text-gray-400">One plugin. One dashboard. Complete visibility.</p>
                        </div>
                        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            {[
                                ...
                                <div key={f.title} className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-shadow hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
                ...
                <section className="px-6 py-24 text-center">
                    <div className="mx-auto max-w-2xl">
                        <h2 className="flex flex-col mb-4 text-3xl font-bold tracking-tight lg:text-4xl">
                        ...
                        {canRegister ? (
                            <Link href={register()} className="inline-block rounded-xl bg-primary px-10 py-4 text-base font-semibold text-primary-foreground shadow-lg hover:opacity-90 transition-opacity">
                                Create your free account →
                            </Link>
                        ) : (
                            <Link href={login()} className="inline-block rounded-xl bg-primary px-10 py-4 text-base font-semibold text-primary-foreground shadow-lg hover:opacity-90 transition-opacity">
